...
project_paths = {
    "genome-nexus": [
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest-gui/genome-nexus/component/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest-gui/genome-nexus/model/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest-gui/genome-nexus/service/src/main/java"
    ],
    "gestaohospital-rest": "/home/ubuntu/EMB/jdk_8_maven/cs/rest-gui/gestaohospital/src/main/java",
    "rest-ncs": "/home/ubuntu/EMB/jdk_8_maven/cs/rest/artificial/ncs/src/main/java",
    "rest-scs": "/home/ubuntu/EMB/jdk_8_maven/cs/rest/artificial/scs/src/main/java",
    "features-service": "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/features-service/src/main/java",
    "catwatch": "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/catwatch/catwatch-backend/src/main/java",
    "languagetool": [
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/languagetool/languagetool-core/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/languagetool/languagetool-server/src/main/java"
    ],
    "proxyprint": "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/proxyprint/src/main/java",
    "restcountries": "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/restcountries/src/main/java",
    "scout-api": [
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/scout-api/api/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/scout-api/auth/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/scout-api/data-access/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/scout-api/data-batch-jobs/src/main/java"
    ],
    "cwa-verification": "/home/ubuntu/EMB/jdk_11_maven/cs/rest/cwa-verification-server/src/main/java",
    "market": [
        "/home/ubuntu/EMB/jdk_11_maven/cs/rest-gui/market/market-core/src/main/java",
        "/home/ubuntu/EMB/jdk_11_maven/cs/rest-gui/market/market-rest/src/main/java",
        "/home/ubuntu/EMB/jdk_11_maven/cs/rest-gui/market/market-web/src/main/java"
    ],
    "ocvn-rest": [
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest-gui/ocvn/web/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest-gui/ocvn/persistence-mongodb/src/main/java",
        "/home/ubuntu/EMB/jdk_8_maven/cs/rest-gui/ocvn/persistence/src/main/java"
    ],
    "pay-publicapi": "/home/ubuntu/EMB/jdk_11_maven/cs/rest/pay-publicapi/src/main/java",
    "reservations-api": "/home/ubuntu/EMB/jdk_11_gradle/cs/rest/reservations-api/src/main/java",
    "session-service": "/home/ubuntu/EMB/jdk_8_maven/cs/rest/original/session-service/src/main/java"
}

# Print the project paths
...
shutil.copy("client-java/instrumentation/target"
         + "/evomaster-client-java-instrumentation-"
         + EVOMASTER_VERSION + ".jar",
         os.path.join(CASESTUDY_DIR, "evomaster-agent.jar"))
...
def addJobBody(port, sut, seed, setting):
    ...
    external_service_ip = generate_ip()
    ...
    params += " --externalServiceIP=" + external_service_ip
    params += " --coveredTargetFile="+REPORT_DIR+"/covered_target_file" + identifier + ".txt"


    ### EXTRA
    params += " --useExtraSqlDbConstraintsProbability=0.9"
    params += " --forceSqlAllColumnInsertion=true"
...
def createJobs():
    ...
    if OPENAI_TOKEN == "":
        raise Exception("You must specify a OPENAI_TOKEN env variable to utilize LLM")
    ...
    for sut in SUTS:
        ...
        prefix = ""
        prefix += "export OPENAI_TOKEN=\""+ OPENAI_TOKEN +"\"\n"
        prefix += "export REPO_PATH=\""
        if isinstance(project_paths[sut.name], list):
            prefix += ",".join(project_paths[sut.name])
        else:
            prefix += project_paths[sut.name]
        prefix += "\""
            ...
            for config in CONFIGS:
                ...
                for setting in config.generateAllSettings():
                    ...
                    # can we add this new run to the current opened script?
                        ...
                        writeWithHeadAndFooter(prefix + code, state.port, sut, state.getTimeoutMinutes())
                        state.resetTmpForNewRun()
                        code = createOneJob(state, sut, seed, setting)
...
def getConfigs():
    ...
    withLLM = ParameterSetting("enableLLMAssistedRequestGeneration", ["true"])

    VE = ParameterSetting("enableValueExpansion", ["true"])
    ...
    CONFIGS.append(Config([], "Base"))
    CONFIGS.append(Config([withLLM,VE], "LLM"))
    CONFIGS.append(Config([withLLM], "LLM-noVE"))
