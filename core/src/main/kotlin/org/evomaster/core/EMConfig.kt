...
//--- properties
    ...
    @Cfg("Whether to apply LLM assisted mock generation.")
    @Experimental
    var enableLLMAssistedMockGeneration = false

    @Cfg("Whether to apply LLM assisted request generation.")
    @Experimental
    var enableLLMAssistedRequestGeneration = false

    @Cfg("Whether to apply value expansion")
    @Experimental
    var enableValueExpansion = false
